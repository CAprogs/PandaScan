...
def show_settings(main_window, SETTINGS, settings_button):
    ...
    if settings_window is None:
        ...
        lhtranslation_checkbox_var = BooleanVar(value=SETTINGS["websites"]["lhtranslation"]["enabled"])
        ...
        def update_settings():
            ...
            labels_to_manage[button_2] = {
                ...
                update_lelmanga: (65.0, 196.0),
                update_mangamoins: (65.0, 216.0),
