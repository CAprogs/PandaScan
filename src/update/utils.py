...
def get_average_time(
    mode: Literal["Manual", "Auto"], selected_website: str, SETTINGS, ALL_WEBSITES: list = []
):  # noqa: B006
...
def confirm_update(mode: str, message: str, SETTINGS, ALL_WEBSITES: list = []):  # noqa: B006
    ...
    result = messagebox.askquestion(
        f"Confirmation Check : {mode}-Update", f"Update {message} ?\n\n{average_time}"
    )  # noqa: E501
    if result == "yes":
        return True
    return False
