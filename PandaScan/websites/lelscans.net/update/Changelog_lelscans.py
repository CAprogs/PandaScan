...
def read_previous_state():
    try:
        with open('lelscans.net/datas/mangas_chapters.yml', 'r') as file:
            return yaml.safe_load(file)
    except FileNotFoundError:
        return {}

def write_current_state(state):
    with open('lelscans.net/datas/mangas_chapters.yml', 'w') as file:
...
def generate_changelog():
    ...
    with open('lelscans.net/datas/mangas_chapters_temp.yml', 'r') as temp_file:
    ...
    with open('lelscans.net/change_report.txt', 'a') as file:
        file.write(report)
    ...
    os.remove('lelscans.net/datas/mangas_chapters_temp.yml')