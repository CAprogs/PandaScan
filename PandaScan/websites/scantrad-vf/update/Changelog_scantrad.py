...
def read_previous_state():
    try:
        with open('scantrad-vf/datas/mangas_chapters.yml', 'r') as file:
            return yaml.safe_load(file)
    except FileNotFoundError:
        return {}

def write_current_state(state):
    with open('scantrad-vf/datas/mangas_chapters.yml', 'w') as file:
...
def generate_changelog():
    ...
    with open('scantrad-vf/datas/mangas_chapters_temp.yml', 'r') as temp_file:
    ...
    with open('scantrad-vf/change_report.txt', 'a') as file:
        file.write(report)
    ...
    os.remove('scantrad-vf/datas/mangas_chapters_temp.yml')