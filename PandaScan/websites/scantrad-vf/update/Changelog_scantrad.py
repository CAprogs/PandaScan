...
def read_previous_state():
    """
    Read the previous state of the mangas chapters from the mangas_chapters.yml file

    Returns:
        dict: The previous state of the mangas chapters
    """    
    try:
...
def write_current_state(state):
    """
    Write the current state of the mangas chapters to the mangas_chapters.yml file

    Args:
        state (dict): The current state of the mangas chapters
    """    
...
def read_update_number():
    """
    Read the update number from the update_number.txt file

    Returns:
        int: The update number
    """    
    try:
...
def write_update_number(number):
    """
    Write the update number to the update_number.txt file

    Args:
        number (int): The update number
    """    
...
def generate_change_report(current_state, previous_state):
    """
    Generate the change report between the current and the previous state of the mangas chapters

    Args:
        current_state (dict): The current state of the mangas chapters
        previous_state (dict): The previous state of the mangas chapters


    Returns:
        str: The change report
    """    
    change_report = []
