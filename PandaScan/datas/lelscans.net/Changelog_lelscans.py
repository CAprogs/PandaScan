...
def read_previous_state():
    try:
        with open('mangas_chapters.yml', 'r') as file:
            return yaml.safe_load(file)
    except FileNotFoundError:
        return {}

def write_current_state(state):
    with open('mangas_chapters.yml', 'w') as file:
...
def generate_changelog():
    ...
    with open('mangas_chapters_temp.yml', 'r') as temp_file:
    ...
    os.remove('mangas_chapters_temp.yml')