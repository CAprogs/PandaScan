...
def Scrap_Chapters():
    ...
    datas = pd.read_csv(f'{script_directory}/mangas.csv') # Parcourir les noms de mangas 
    ...
    # Sauvegarde des datas
    datas.to_csv(f'{script_directory}/mangas.csv', index=False)

    with open(f'{script_directory}/mangas_chapters_temp.yml', 'w') as file:
        file.write(yml_data)
